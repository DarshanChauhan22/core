...
<script type="text/javascript">
	...
	{
		var page = ele.value;
		var pageUrl = "<?php echo $controllerCoreAction->getUrl('grid','salesman',['p' => $this->getPager()->getStart()],true) ?>&ppr="+ele.value;
...
<?php endif;?>
	...
	<form action="<?php echo $controllerCoreAction->getUrl('add','salesman',['p' => $this->getPager()->getEnd()],false) ?>" method="POST">
			...
			<?php if($salesmans):
				foreach ($salesmans as $salesman): ?>
					<tr>
			    		...
			    		<td>
			    			<a href="<?php echo$controllerCoreAction->getUrl('edit','salesman',['id' =>  $salesman->salesmanId],false) ?>">Update</a>
			    		</td>
			    		<td>
			    			<a href="<?php echo$controllerCoreAction->getUrl('delete','salesman',['id' =>  $salesman->salesmanId],false) ?>">Delete</a> 
			    		</td>
			   		</tr>
			 	<?php endforeach;?>
			<?php else:?>
