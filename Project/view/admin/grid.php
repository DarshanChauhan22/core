...
<script type="text/javascript">
	...
	{
		var page = ele.value;
		var pageUrl = "<?php echo $controllerCoreAction->getUrl('grid','admin',['p' => $this->getPager()->getStart()],true) ?>&ppr="+ele.value;
...
<?php endif;?>
	...
	<h1> Admin Details </h1> 
	<form action="<?php echo $controllerCoreAction->getUrl('add','admin',['p' => $this->getPager()->getEnd()],false) ?>" method="POST">
			...
			<?php if($admins):
				foreach ($admins as $admin): ?>
					<tr>
			    		...
			    		<td>
			    			<a href="<?php echo$controllerCoreAction->getUrl('edit','admin',['id' =>  $admin->adminId],false) ?>">Update</a>
			    		</td>
			    		<td>
			    			<a href="<?php echo$controllerCoreAction->getUrl('delete','admin',['id' =>  $admin->adminId],false) ?>">Delete</a> 
			    		</td>
			   		</tr>
			 	<?php endforeach;?>
			<?php else:?>
