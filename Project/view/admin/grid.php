...
<?php endif;?>
	...
	<h1> Admin Details </h1> 
	<form action="<?php echo $this->getUrl('add','admin',['p' => $this->getPager()->getEnd()],false) ?>" method="POST">
			...
			<?php if($admins):
				foreach ($admins as $admin): ?>
					<tr>
			    		...
			    		<td>
			    			<a href="<?php echo $this->getUrl('edit','admin',['id' =>  $admin->adminId],false) ?>">Update</a>
			    		</td>
			    		<td>
			    			<a href="<?php echo $this->getUrl('delete','admin',['id' =>  $admin->adminId],false) ?>">Delete</a> 
			    		</td>
			   		</tr>
			 	<?php endforeach;?>
			<?php else:?>
